    ...
    <div className="w-64 h-screen bg-[#F8F9FB] flex flex-col justify-between px-6 py-6">
      ...
      <div>
        ...
        <ul className="space-y-3 text-gray-600">
          <li>
            <Link
              to="/"
              className="flex items-center gap-3 bg-white shadow-sm px-4 py-3 rounded-xl font-medium"
            >
          ...
          <li>
            <Link
              to="/orders"
              className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white hover:shadow-sm cursor-pointer"
            >
      ...
      <div>
        <div className="bg-green-500 rounded-2xl p-4 text-white flex justify-between items-center">
          ...
          <img src="/img/cs2.png" className="w-18 h-18 rounded-full" />
        </div>
